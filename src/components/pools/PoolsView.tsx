...
import { Plus, Search, RotateCw, Droplets, ArrowUpRight, Sparkles, AlertCircle } from 'lucide-react';

export const PoolsView: React.FC = () => {
  const { pools, isLoadingPools, refreshPools, setActiveView } = useProtocol();
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        <div>
          ...
          <div className="flex items-center gap-3 mt-1 text-xs text-[var(--text-secondary)]">
            <span>Deposit dual-token assets into concentrated price ticks to earn automated protocol swap fees.</span>
