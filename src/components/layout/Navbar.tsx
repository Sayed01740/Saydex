          ...
          <div className="flex items-center gap-2.5">
            ...
            <div className="relative">
              ...
              {isChainDropdownOpen && (
                <>
                  ...
                  />
                  <div className="fixed sm:absolute top-16 sm:top-auto left-4 right-4 sm:left-auto sm:right-0 mt-2 sm:w-64 bg-[var(--bg-surface)] border border-[var(--border-app)] rounded-2xl sm:rounded-xl shadow-2xl z-40 py-2 sm:py-1.5 overflow-hidden">
            ...
            {isConnected ? (
              <button
                ...
                className="flex items-center gap-1.5 sm:gap-2 px-2.5 sm:px-3 py-1.5 rounded-xl bg-[var(--bg-surface-elevated)] border border-[var(--border-app)] hover:border-[var(--primary)]/50 transition-all text-xs font-semibold text-[var(--text-primary)] cursor-pointer shadow-xs shrink-0"
              >
                ...
                <span className="font-mono px-1 sm:px-1.5 py-0.5 rounded bg-[var(--bg-subtle)] border border-[var(--border-subtle)] text-[10px] sm:text-[11px]">
                  {ensName || formatAddress(address, 3)}
                </span>
              </button>
            ) : (
              <Button
                variant="primary"
                size="sm"
                className="px-2.5 sm:px-3 text-xs whitespace-nowrap"
                onClick={() => setIsWalletModalOpen(true)}
              >
                <span>Connect</span>
